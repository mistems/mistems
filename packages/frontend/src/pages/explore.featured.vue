			...
			<div :class="$style.gridCell">
				...
				<div :class="$style.gridRow">
					...
					<div :class="$style.swatchRow">
						<button v-for="o in lightAoOptions" :key="o.value" type="button" :class="[$style.swatch, { [$style.swatchSelected]: favstarLightAo === o.value }]" :style="{ background: o.value }" :title="o.label" @click="favstarLightAo = o.value"/>
					</div>
				</div>
				<div :class="$style.gridRow">
					<span :class="$style.kindLabel">赤ふぁぼ</span>
					<div :class="$style.swatchRow">
						<button v-for="o in lightAkaOptions" :key="o.value" type="button" :class="[$style.swatch, { [$style.swatchSelected]: favstarLightAka === o.value }]" :style="{ background: o.value }" :title="o.label" @click="favstarLightAka = o.value"/>
					</div>
				</div>
			</div>
			<div :class="$style.gridCell">
				...
				<div :class="$style.gridRow">
					<span :class="$style.kindLabel">青ふぁぼ</span>
					<div :class="$style.swatchRow">
						<button v-for="o in darkAoOptions" :key="o.value" type="button" :class="[$style.swatch, { [$style.swatchSelected]: favstarDarkAo === o.value }]" :style="{ background: o.value }" :title="o.label" @click="favstarDarkAo = o.value"/>
					</div>
				</div>
				<div :class="$style.gridRow">
					<span :class="$style.kindLabel">赤ふぁぼ</span>
					<div :class="$style.swatchRow">
						<button v-for="o in darkAkaOptions" :key="o.value" type="button" :class="[$style.swatch, { [$style.swatchSelected]: favstarDarkAka === o.value }]" :style="{ background: o.value }" :title="o.label" @click="favstarDarkAka = o.value"/>
					</div>
				</div>
			</div>
		</div>
