...
<div ref="rootEl" :class="$style.root">
	...
	<button v-if="isChannel" :class="[$style.item, $style.post]" class="_button" @click="os.post()">
		<div :class="$style.itemInner">
			<i :class="$style.itemIcon" class="ti ti-device-tv"></i>
		</div>
	</button>
	<button v-if="!isChannel || showLocalTimelinePostButtonInChannel" :class="[$style.item, $style.post, isChannel ? $style.postButtonFloat : undefined]" class="_button" @click="os.post({}, { forceTimeline: true })">
		<div :class="$style.itemInner">
