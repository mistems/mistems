	...
	<div :class="$style.body">
		...
		<div :class="$style.middle">
			...
			<template v-for="item in prefer.r.menu.value">
				...
				>
					<i class="ti-fw" :class="[$style.itemIcon, navbarItemDef[item].icon]" :style="{ view-transition-name: 'navbar-item-' + item }"></i><span :class="$style.itemText">{{ navbarItemDef[item].title }}</span>
